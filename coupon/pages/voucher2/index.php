...
<body class="bg2 container-fluid">
		...
		<div class="card front2 ">
			...
			<form method="post" action="" id="register_form">
				<div align="center"><span class="card-title"><i>Welcome to</i></span>
  				 ...
  				 <div align="center"><span class="card-body "><h5>ADEHYE HALL PAGEANTS VOTING</span>
            ...
            <input id="input" type="text" name="code" id="code" placeholder="Type coupon here..." >
  	  			...
  	  			<div class="row"></div>
		  		<div align="center">
		  			<button class="btnw btn waves-effect waves-light z-depth-4" type="submit" name="register2" id="register">Activate
		  			</button>
